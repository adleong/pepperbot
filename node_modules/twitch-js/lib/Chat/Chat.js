...
var Chat = /** @class */ (function (_super) {
    ...
    function Chat(options) {
        ...
        _this._readyState = types_2.ChatReadyStates.WAITING;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 7]);
                        this._readyState = types_2.ChatReadyStates.CONNECTING;
                        if (this._connectionInProgress) {
                            return [2 /*return*/, this._connectionInProgress];
                        }
                        _a = this;
                        return [4 /*yield*/, p_timeout_1.default(this._handleConnectionAttempt(), this._options.connectionTimeout)];
                    case 1:
                        _a._connectionInProgress = _b.sent();
                        this._readyState = types_2.ChatReadyStates.CONNECTED;
                        this._connectionAttempts = 0;
                        return [3 /*break*/, 7];
                    case 2:
                        err_1 = _b.sent();
                        if (!(this._readyState !== types_2.ChatReadyStates.DISCONNECTING &&
                            this._readyState !== types_2.ChatReadyStates.DISCONNECTED)) return [3 /*break*/, 5];
                        this._log.info('Retrying ...');
                        return [4 /*yield*/, delay_1.default(this._options.connectionTimeout)];
                    case 3:
                        _b.sent();
                        return [4 /*yield*/, this._handleAuthenticationFailure()];
                    case 4:
                        _b.sent();
    ...
    Chat.prototype.disconnect = function () {
        var _a;
        this._readyState = types_2.ChatReadyStates.DISCONNECTING;
        (_a = this._client) === null || _a === void 0 ? void 0 : _a.disconnect();
        this._readyState = types_2.ChatReadyStates.DISCONNECTED;
    };
    /**
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this._readyState = types_2.ChatReadyStates.RECONNECTING;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all([
                                ...
                                // @ts-expect-error EventTypes breaks this
                                this, [
                                    types_2.NoticeCompounds.BAN_SUCCESS + "/" + channel,
                                    types_2.NoticeCompounds.ALREADY_BANNED + "/" + channel,
                                ]),
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all([
                                p_event_1.default(
                                // @ts-expect-error EventTypes breaks this
                                this, [types_2.NoticeCompounds.COLOR_CHANGED + "/" + channel]),
                                this.say(channel, message),
                            ])];
                    case 1:
                        _a = __read.apply(void 0, [_b.sent(), 1]), notice = _a[0];
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all([
                                p_event_1.default(
                                // @ts-expect-error EventTypes breaks this
                                this, [types_2.NoticeCompounds.COMMERCIAL_SUCCESS + "/" + channel]),
                                this.say(channel, message),
                            ])];
                    case 1:
                        _a = __read.apply(void 0, [_b.sent(), 1]), notice = _a[0];
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all([
                                ...
                                // @ts-expect-error EventTypes breaks this
                                this, [
                                    types_2.NoticeCompounds.EMOTE_ONLY_ON + "/" + channel,
                                    types_2.NoticeCompounds.ALREADY_EMOTE_ONLY_ON + "/" + channel,
                                ]),
                                this.say(channel, message),
                            ])];
                    case 1:
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all([
                                ...
                                // @ts-expect-error EventTypes breaks this
                                this, [
                                    types_2.NoticeCompounds.EMOTE_ONLY_OFF + "/" + channel,
                                    types_2.NoticeCompounds.ALREADY_EMOTE_ONLY_OFF + "/" + channel,
                                ]),
                                this.say(channel, message),
                            ])];
                    case 1:
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all([
                                ...
                                // @ts-expect-error EventTypes breaks this
                                this, [
                                    types_2.NoticeCompounds.FOLLOWERS_ONZERO + "/" + channel,
                                    types_2.NoticeCompounds.FOLLOWERS_ON + "/" + channel,
                                ]),
                                this.say(channel, message),
                            ])];
                    case 1:
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all([
                                p_event_1.default(
                                // @ts-expect-error EventTypes breaks this
                                this, [types_2.NoticeCompounds.FOLLOWERS_OFF + "/" + channel]),
                                this.say(channel, message),
                            ])];
                    case 1:
                        _a = __read.apply(void 0, [_b.sent(), 1]), notice = _a[0];
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all([
                                p_event_1.default(
                                // @ts-expect-error EventTypes breaks this
                                this, [types_2.NoticeCompounds.CMDS_AVAILABLE + "/" + channel]),
                                this.say(channel, message),
                            ])];
                    case 1:
                        _a = __read.apply(void 0, [_b.sent(), 1]), notice = _a[0];
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all([
                                p_event_1.default(
                                // @ts-expect-error EventTypes breaks this
                                this, [types_2.NoticeCompounds.HOST_ON + "/" + channel]),
                                this.say(channel, message),
                            ])];
                    case 1:
                        _a = __read.apply(void 0, [_b.sent(), 1]), notice = _a[0];
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all([
                                p_event_1.default(
                                // @ts-expect-error EventTypes breaks this
                                this, [types_2.NoticeCompounds.MOD_SUCCESS + "/" + channel]),
                                this.say(channel, message),
                            ])];
                    case 1:
                        _a = __read.apply(void 0, [_b.sent(), 1]), notice = _a[0];
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all([
                                p_event_1.default(
                                // @ts-expect-error EventTypes breaks this
                                this, [types_2.NoticeCompounds.ROOM_MODS + "/" + channel]),
                                this.say(channel, message),
                            ])];
                    case 1:
                        _a = __read.apply(void 0, [_b.sent(), 1]), notice = _a[0];
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all([
                                ...
                                // @ts-expect-error EventTypes breaks this
                                this, [
                                    types_2.NoticeCompounds.R9K_ON + "/" + channel,
                                    types_2.NoticeCompounds.ALREADY_R9K_ON + "/" + channel,
                                ]),
                                this.say(channel, message),
                            ])];
                    case 1:
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all([
                                ...
                                // @ts-expect-error EventTypes breaks this
                                this, [
                                    types_2.NoticeCompounds.R9K_OFF + "/" + channel,
                                    types_2.NoticeCompounds.ALREADY_R9K_OFF + "/" + channel,
                                ]),
                                this.say(channel, message),
                            ])];
                    case 1:
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all([
                                p_event_1.default(
                                // @ts-expect-error EventTypes breaks this
                                this, [types_2.NoticeCompounds.SLOW_ON + "/" + channel]),
                                this.say(channel, message),
                            ])];
                    case 1:
                        _a = __read.apply(void 0, [_b.sent(), 1]), notice = _a[0];
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all([
                                p_event_1.default(
                                // @ts-expect-error EventTypes breaks this
                                this, [types_2.NoticeCompounds.SLOW_OFF + "/" + channel]),
                                this.say(channel, message),
                            ])];
                    case 1:
                        _a = __read.apply(void 0, [_b.sent(), 1]), notice = _a[0];
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all([
                                ...
                                // @ts-expect-error EventTypes breaks this
                                this, [
                                    types_2.NoticeCompounds.SUBS_ON + "/" + channel,
                                    types_2.NoticeCompounds.ALREADY_SUBS_ON + "/" + channel,
                                ]),
                                this.say(channel, message),
                            ])];
                    case 1:
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all([
                                ...
                                // @ts-expect-error EventTypes breaks this
                                this, [
                                    types_2.NoticeCompounds.SUBS_OFF + "/" + channel,
                                    types_2.NoticeCompounds.ALREADY_SUBS_OFF + "/" + channel,
                                ]),
                                this.say(channel, message),
                            ])];
                    case 1:
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all([
                                p_event_1.default(
                                // @ts-expect-error EventTypes breaks this
                                this, [types_2.NoticeCompounds.TIMEOUT_SUCCESS + "/" + channel]),
                                this.say(channel, message),
                            ])];
                    case 1:
                        _a = __read.apply(void 0, [_b.sent(), 1]), notice = _a[0];
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all([
                                p_event_1.default(
                                // @ts-expect-error EventTypes breaks this
                                this, [types_2.NoticeCompounds.UNBAN_SUCCESS + "/" + channel]),
                                this.say(channel, message),
                            ])];
                    case 1:
                        _a = __read.apply(void 0, [_b.sent(), 1]), notice = _a[0];
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all([
                                p_event_1.default(
                                // @ts-expect-error EventTypes breaks this
                                this, [types_2.NoticeCompounds.HOST_OFF + "/" + channel]),
                                this.say(channel, message),
                            ])];
                    case 1:
                        _a = __read.apply(void 0, [_b.sent(), 1]), notice = _a[0];
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all([
                                p_event_1.default(
                                // @ts-expect-error EventTypes breaks this
                                this, [types_2.NoticeCompounds.UNMOD_SUCCESS + "/" + channel]),
                                this.say(channel, message),
                            ])];
                    case 1:
                        _a = __read.apply(void 0, [_b.sent(), 1]), notice = _a[0];
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all([
                                p_event_1.default(
                                // @ts-expect-error EventTypes breaks this
                                this, [types_2.NoticeCompounds.UNRAID_SUCCESS + "/" + channel]),
                                this.say(channel, message),
                            ])];
                    case 1:
                        _a = __read.apply(void 0, [_b.sent(), 1]), notice = _a[0];
    ...
    Chat.prototype._handleConnectionAttempt = function () {
        ...
        return new p_cancelable_1.default(function (resolve, reject) {
            ...
            // Connect ...
            _this._readyState = types_2.ChatReadyStates.CONNECTING;
            ...
            // Handle disconnects.
            _this._client.on(types_1.ClientEvents.DISCONNECTED, _this._handleDisconnect, _this);
            // Listen for reconnects.
            _this._client.once(types_1.ClientEvents.RECONNECT, function () { return _this.reconnect(); });
            // Listen for authentication failure.
            _this._client.once(types_1.ClientEvents.AUTHENTICATION_FAILED, reject);
            // Once the client is connected, resolve ...
            _this._client.once(types_1.ClientEvents.CONNECTED, function (message) {
                if (token && username) {
                    _this._handleAuthenticated(message);
                }
            ...
            // Handle messages.
            _this._client.on(types_1.ClientEvents.ALL, _this._handleMessage, _this);
        });
    };
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        throw new Errors.AuthenticationError(err_2);
    ...
    Chat.prototype._handleMessage = function (baseMessage) {
        ...
        try {
            ...
            this.emit(types_1.ClientEvents.ERROR_ENCOUNTERED, error);
        }
    };
    ...
    Chat.CompoundEvents = (_a = {},
        _a[twitch_1.Events.NOTICE] = types_2.NoticeCompounds,
        _a[twitch_1.Events.PRIVATE_MESSAGE] = types_2.PrivateMessageCompounds,
        _a[twitch_1.Events.USER_NOTICE] = types_2.UserNoticeCompounds,
        _a);
    return Chat;
