...
var IrcClient = /** @class */ (function (_super) {
    ...
    function IrcClient(options) {
        ...
        if (channels) {
            _this.onRegister(function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        errorListener = _this.onTypedMessage(Commands_1.ErrorMessage, function (msg) {
                            registerListener.unbind();
                            _this.removeMessageListener(errorListener);
                            disconnectListener.unbind();
    ...
    IrcClient.prototype.say = function (target, message, tags) {
        if (tags === void 0) { tags = {}; }
        this.sendMessage(Commands_1.PrivateMessage, { target: target, message: message }, tags);
    };
                            ...
                            case 0:
                                ...
                                return [4 /*yield*/, Promise.all([
                                        ...
                                        this.sendMessageAndCaptureReply(Commands_1.CapabilityNegotiation, {
                                            ...
                                            _this._serverCapabilities = new Map(Object.entries(Object.assign.apply(Object, tslib_1.__spread([{}], capLists))));
