...
var HelixEventSubApi = /** @class */ (function (_super) {
    ...
    HelixEventSubApi.prototype.subscribeToChannelRaidEventsFrom = function (broadcaster, transport) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.createSubscription('channel.raid', '1', { from_broadcaster_user_id: extractUserId(broadcaster) }, transport)];
            });
        });
    };
    /**
    ...
    HelixEventSubApi.prototype.subscribeToChannelRaidEventsTo = function (broadcaster, transport) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.createSubscription('channel.raid', '1', { to_broadcaster_user_id: extractUserId(broadcaster) }, transport)];
            });
        });
    };
    /**
    ...
    HelixEventSubApi.prototype.subscribeToChannelRewardRemoveEvents = function (broadcaster, transport) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.createSubscription('channel.channel_points_custom_reward.remove', '1', { broadcaster_user_id: extractUserId(broadcaster) }, transport)];
            });
        });
    };
    /**
