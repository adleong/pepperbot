...
var ApiClient = /** @class */ (function () {
    ...
    function ApiClient(config) {
        ...
        this._helixRateLimiter = new HelixRateLimiter_1.HelixRateLimiter({ logger: tslib_1.__assign({ minLevel: config.logLevel }, config.logger) });
     ...
     */
    ApiClient.prototype.requestScopes = function (scopes) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                if (options.type === twitch_api_call_1.TwitchApiCallType.Helix) {
                    return [2 /*return*/, this._helixRateLimiter.request({ options: options, clientId: clientId, accessToken: accessToken, fetchOptions: fetchOptions })];
                }
